...
!====================================================
subroutine calc_HO(H,THREEBOD,jbas,D)
  ! returns H in the normal orderd Harmonic Oscillator basis
  implicit none 
  ...
  print*, 'Computing Harmonic Oscillator Basis...'
 ...
 ! e_HF is calculated in the hartree fock basis
 H%E0 = e_HF(T,Vgam,V3gam,jbas)
 write(*,'(A29,f12.7)') ' Harmonic Oscillator Energy: ',H%E0
 if ( tbforce ) call meanfield_2b(rho,H,THREEBOD,jbas) 
 call transform_2b_to_HF(D,H,jbas) 

end subroutine calc_HO
!====================================================
